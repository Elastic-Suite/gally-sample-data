...
class GenerateTestDataCommand extends Command
{
    ...
    {
        $this
            ->addOption('preset', 'p', InputOption::VALUE_REQUIRED, 'Use a preset configuration (small, medium, large, extra-large)')
            ...
            ->addOption('seed', null, InputOption::VALUE_REQUIRED, 'Seed for random generation, as an integer, for reproducibility (e.g., --seed=42). With the same value, you\'ll have the same randomly generated catalogs.')
            ->addOption('memory-limit', null, InputOption::VALUE_REQUIRED, 'PHP memory limit for the generation process (e.g., 512M, 2G)', '2G');
    }
